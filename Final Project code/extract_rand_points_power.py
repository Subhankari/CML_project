...
norm1_path = '/work/sm6202/ML/data/power_norm_f1'
norm2_path = '/work/sm6202/ML/data/power_norm_f2'
f10_features = '/work/sm6202/ML/data/100_power_features_all'
...
#            break
        ...
        random_10 = np.random.randint(data.shape[0], size = 100)
    ...
    for filename in listdir(norm2_path):
        data = np.zeros((1,128))
        data = np.matrix(data)
#        if i > 200:
#            break
        ...
        #if i > 3:
        #    break
        with open(join(norm2_path,filename)) as f:
            for line in f:
                j = j + 1
                #if j > 1:
                #    break
